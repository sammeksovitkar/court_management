...
const CourtRegister = () => {
    ...
    const config = {
        ...
        PostTracking: { title: "A Register", endpoint: "/post-tracking", lang: "both", color: "purple", isTracking: true, fields: [{ id: 'date', label: 'Date' }, { id: 'officeSrNo', label: 'Sr. No.' }, { id: 'source', label: 'Register' }, { id: 'toWhom', label: 'Sent To' }, { id: 'subject', label: 'Subject' }, { id: 'stampAmount', label: 'Amount (₹)' }] }
    };
